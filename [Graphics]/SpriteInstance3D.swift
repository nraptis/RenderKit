...
public class SpriteInstance3D {
    
    public init() {
        
    }
    
    public var blendMode = SpriteInstance2D.BlendMode.none
    ...
    public var isVertexBufferDirty = true
    public var isIndexBufferDirty = true
    
    public var isUniformsVertexBufferDirty = true
    public var isUniformsFragmentBufferDirty = true
